      ...
      <section v-if="currentStep === 2" class="mt-5 rounded-lg border border-white/[.08] bg-white/[.025] p-5 md:p-6">
        ...
        <div class="mt-5 grid gap-4">
          ...
          <label class="block">
            ...
            <textarea v-model="form.brief" rows="7" class="mt-2 w-full resize-y rounded-lg border border-white/[.08] bg-black/20 px-4 py-3 text-sm leading-6 text-white outline-none transition placeholder:text-white/24 focus:border-purple-400/55 focus:bg-black/30" placeholder="Tulis arahan campaign, gaya video, larangan, atau asset yang perlu dipakai."></textarea>
          </label>
        </div>
      </section>
