...
<template>
  <AppShell>
    ...
    <div class="mb-5 flex flex-wrap items-center gap-3">
      ...
      <input v-model="query" class="h-11 min-w-72 rounded-lg border border-white/10 bg-white/[.045] px-4 text-[13px] font-medium text-white outline-none placeholder:text-white/42 focus:border-purple-400" placeholder="Cari campaign atau brand..." />
      ...
      <div class="relative">
        <select v-model="category" class="h-11 min-w-36 appearance-none rounded-lg border border-white/10 bg-white/[.045] px-4 pr-9 text-[13px] font-medium text-white/78 outline-none hover:border-purple-400/45">
      ...
      <div class="relative">
        <select v-model="type" class="h-11 min-w-32 appearance-none rounded-lg border border-white/10 bg-white/[.045] px-4 pr-9 text-[13px] font-medium text-white/78 outline-none hover:border-purple-400/45">
